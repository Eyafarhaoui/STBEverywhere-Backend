    ...
    public partial class globalmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_convention = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    nom_convention = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    marge_bancaire = table.Column<decimal>(type: "decimal(5,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conventions", x => x.id_convention);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatutVirement = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    OtpCode = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StatutOtpCode = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: true),
                    ResetPasswordTokenExpiry = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    id_convention = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Clients_Conventions_id_convention",
                        column: x => x.id_convention,
                        principalTable: "Conventions",
                        principalColumn: "id_convention");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumCin = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DecouvertAutorise = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    idAgent = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ClientId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ClientId = table.Column<int>(type: "int", nullable: false),
                    FieldToModify = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NewValue = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    JustificationPath = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RIBCompte = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DecouvertDemande = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModeLivraison = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    NumTel = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PlafondChequier = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Montant = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date_jour = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    RIB = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoriquesSoldes", x => x.Id_historique);
                    table.ForeignKey(
                        name: "FK_HistoriquesSoldes_Comptes_RIB",
                        column: x => x.RIB,
                        principalTable: "Comptes",
                        principalColumn: "RIB",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCalcul = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InteretsJournaliers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InteretsJournaliers_Comptes_RIB",
                        column: x => x.RIB,
                        principalTable: "Comptes",
                        principalColumn: "RIB",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FraisChequiers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FraisChequiers_Chequiers_ChequierId",
                        column: x => x.ChequierId,
                        principalTable: "Chequiers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FraisChequiers_DemandesChequiers_IdDemande",
                        column: x => x.IdDemande,
                        principalTable: "DemandesChequiers",
                        principalColumn: "IdDemande",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2.0m, "CNRPS" },
                    { 3, 3.0m, "CNAM" },
                    { 4, 3.5m, "MUTUELLE STEG" },
                    { 5, 4.0m, "SYNDICAT TUNISIEN MEDECINS DENTISTE DE LIBRE PRATIQUES" },
                    { 6, 3.5m, "OFFICE NATIONAL DES POSTES TUNISIENNES" },
                    { 7, 6.0m, "AMICALE MINISTERE ENSEIGNEMENT SUPERIEUR ET RECHERCHE SCIENTIFI" },
                    { 8, 1.0m, "MUTUELLE STEG" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "farhaouieya@gmail.com", true, "$2a$11$pwr3JjNwhgyO525aLaH6J.N4lXx20nguhi3TcbBw2AO3t5rXPLICW", null, null, "Client" },
                    { 2, "ikramguesmi75@gmail.com", true, "$2a$11$EnxevdNt70l2HPmd6FR7He4kJHwt0kBYdxj3/YLJimKh.cnKN/nNO", null, null, "Client" },
                    { 3, "agent@stb.com", true, "$2a$11$lSv3idZj3.4/DFcbbTeO1u9qk1RX2y8mbNif0NgpJH/9PD321.UdW", null, null, "Agent" },
                    { 4, "mouradfarhaoui1967@gmail.com", true, "$2a$11$8O3o11L/ntuA9WpnOyRDVegX5/nN2Ubk3nFjw7d9WdjrshK3HrRh2", null, null, "Client" },
                    { 5, "agent5@stb.com", true, "$2a$11$LUMLlP.Cdc0jKQyxwqRSlO5pDxpQo.b713Zv/wm1aFjBCvDsGXcMS", null, null, "Agent" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "6801861dfe110f2e59031111", "Administration", "Admin", "STB", 3 },
                    { 2, "6801861dfe110f2e59031112", "Administration", "Admin5", "STB5", 5 }
                });

            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "Adresse", "AgenceId", "Civilite", "DateDelivranceCIN", "DateExpirationCIN", "DateNaissance", "Email", "EtatCivil", "Genre", "LieuDelivranceCIN", "Nationalite", "NiveauEducation", "Nom", "NomMere", "NomPere", "NombreEnfants", "NumCIN", "PaysNaissance", "PhotoClient", "Prenom", "Profession", "ResetPasswordToken", "ResetPasswordTokenExpiry", "Residence", "RevenuMensuel", "SituationProfessionnelle", "Telephone", "UserId", "id_convention" },
                values: new object[,]
                {
                    { 1, "123 Rue Tunis", "6801861dfe110f2e59031111", "M", new DateTime(2010, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2030, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "farhaouieya@gmail.com", "Marié(e)", "Masculin", "Tunis", "TN", "Master", "Guesmi", "Mère Mahmoud", "Père Mahmoud", 2, "14668061", "Tunisie", "image1.jpg", "Mahmoud", "Ingénieur", null, null, "Tunis", 5000.00m, "Employé", "94626064", 1, 1 },
                    { 2, "456 Avenue Habib Bourguiba", "6801861dfe110f2e59031111", "Mme", new DateTime(2015, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2035, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "ikramguesmi75@gmail.com", "Célibataire", "Féminin", "Sfax", "TN", "Doctorat", "Guesmi", "Mère Ikram", "Père Ikram", 0, "14668063", "Tunisie", "image3.jpg", "Ikram", "Médecin", null, null, "Sfax", 7000.00m, "Indépendant", "987654321", 2, 2 },
                    { 3, "789 Rue de la Liberté", "6801861dfe110f2e59031112", "Mme", new DateTime(2016, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2036, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1985, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "guesmii.ikram@gmail.com", "Marié(e)", "Féminin", "Sousse", "TN", "Master", "Jemai", "Mère Hayet", "Père Hayet", 3, "14668065", "Tunisie", "image2.jpg", "Hayet", "Avocate", null, null, "Sousse", 6000.00m, "Profession libérale", "987654322", null, 3 },
                    { 4, "123 Rue Tunis", "6801861dfe110f2e59031111", "M", new DateTime(2010, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2030, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "mouradfarhaoui1967@gmail.com", "Marié(e)", "Masculin", "Tunis", "TN", "Master", "Farhaoui", "Mère Mahmoud", "Père Mahmoud", 2, "14668061", "Tunisie", "mahmoud.jpg", "Eya", "Ingénieur", null, null, "Tunis", 5000.00m, "Employé", "55292557", 4, 1 }
                });

            migrationBuilder.InsertData(
                table: "Comptes",
                columns: new[] { "RIB", "ClientId", "DateCreation", "DecouvertAutorise", "IBAN", "NumCin", "Solde", "Statut", "Type", "idAgent" },
                values: new object[,]
                {
                    { "10000001121041340847", 1, new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 0m, "TN7410000001121041347", "14668061", 1000.50m, "Actif", "Courant", null },
                    { "10002840658225593444", 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "TN2010002840658225544", "14668062", 5000.00m, "Actif", "Courant", null },
                    { "10002960033351809624", 4, new DateTime(2025, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "TN4710002960033351824", "14668061", 5000.00m, "Actif", "eparge", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "14668061", true, new DateTime(2025, 6, 10, 12, 43, 16, 248, DateTimeKind.Local).AddTicks(7647), "guesmiimahmoud@gmail.com", false, false, "VisaClassic", "10000001121041340847", "12345678", "DisponibleEnAgence", "International" },
                    { 2, "14668062", true, new DateTime(2025, 6, 10, 12, 43, 16, 248, DateTimeKind.Local).AddTicks(7665), "ikramguesmi75@gmail.com", false, false, "Mastercard", "10002840658225593444", "87654321", "EnPreparation", "National" }
                });

            migrationBuilder.InsertData(
                table: "Cartes",
                columns: new[] { "NumCarte", "CodePIN", "CompteRIB", "DateCreation", "DateExpiration", "DateRecuperation", "Iddemande", "Nature", "NomCarte", "PlafondDAP", "PlafondTPE", "RIB", "Statut", "TypeCarte" },
                values: new object[,]
                {
                    { "4314052233334444", "", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2027, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 1, "postpayee", "VisaClassic", 2000m, 4000m, "10000001121041340847", "Active", "International" },
                    { "5189326677778888", "", null, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2027, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 2, "postpayee", "Mastercard", 2000m, 4000m, "10002840658225593444", "Active", "National" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FraisChequiers_IdDemande",
                table: "FraisChequiers",
                column: "IdDemande");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InteretsJournaliers_RIB",
                table: "InteretsJournaliers",
                column: "RIB");
