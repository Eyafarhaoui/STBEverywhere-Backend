...
namespace STBEverywhere_Back_SharedModels.Migrations
{
    ...
    [Migration("20250610114317_globalmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemandeCarte", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CIN = "14668061",
                            CarteAjouter = true,
                            DateCreation = new DateTime(2025, 6, 10, 12, 43, 16, 248, DateTimeKind.Local).AddTicks(7647),
                        ...
                        new
                        {
                            ...
                            CIN = "14668062",
                            CarteAjouter = true,
                            DateCreation = new DateTime(2025, 6, 10, 12, 43, 16, 248, DateTimeKind.Local).AddTicks(7665),
            ...
            modelBuilder.Entity("ModificationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("JustificationPath")
                        .IsRequired()
                        .HasMaxLength(255)
                    ...
                    b.Property<int?>("ProcessedByAgentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Client", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Civilite = "Mme",
                            DateDelivranceCIN = new DateTime(2016, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateExpirationCIN = new DateTime(2036, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateNaissance = new DateTime(1985, 8, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "guesmii.ikram@gmail.com",
                            EtatCivil = "Marié(e)",
                            Genre = "Féminin",
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Compte", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            ClientId = 4,
                            DateCreation = new DateTime(2025, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.Convention", b =>
                {
                    b.Property<int>("id_convention")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<decimal>("marge_bancaire")
                        .HasColumnType("decimal(5,2)");

                    b.Property<string>("nom_convention")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");

                    b.HasKey("id_convention");
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.FraisCarte", b =>
                {
                    ...
                    b.Property<string>("IdsRechargesStr")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("IdsRecharges");
                    ...
                    b.Property<int?>("RechargeCarteId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RechargeCarteId");

                    b.ToTable("FraisCartes");
                });

            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.FraisChequier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.HistoriqueSolde", b =>
                {
                    ...
                    b.ToTable("HistoriquesSoldes");
                });

            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.InteretJournalier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("InteretsJournaliers");
                });

            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.NotificationReclamation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationsReclamation");
                });
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "farhaouieya@gmail.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$pwr3JjNwhgyO525aLaH6J.N4lXx20nguhi3TcbBw2AO3t5rXPLICW",
                            Role = "Client"
                        },
                        new
                        {
                            ...
                            Email = "ikramguesmi75@gmail.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$EnxevdNt70l2HPmd6FR7He4kJHwt0kBYdxj3/YLJimKh.cnKN/nNO",
                            Role = "Client"
                        },
                        new
                        {
                            ...
                            Email = "mouradfarhaoui1967@gmail.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$8O3o11L/ntuA9WpnOyRDVegX5/nN2Ubk3nFjw7d9WdjrshK3HrRh2",
                            Role = "Client"
                        },
                        new
                        {
                            ...
                            Email = "agent@stb.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$lSv3idZj3.4/DFcbbTeO1u9qk1RX2y8mbNif0NgpJH/9PD321.UdW",
                            Role = "Agent"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$LUMLlP.Cdc0jKQyxwqRSlO5pDxpQo.b713Zv/wm1aFjBCvDsGXcMS",
                            Role = "Agent"
                        });
                });
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Virement", b =>
                {
                    ...
                    b.Property<int?>("StatutOtpCode")
                        .HasColumnType("int");

                    b.Property<string>("StatutVirement")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Client", b =>
                {
                    ...
                    b.HasOne("STBEverywhere_Back_SharedModels.Models.Convention", "Convention")
                        .WithMany()
                        .HasForeignKey("id_convention");
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.FraisCarte", b =>
                {
                    ...
                    b.HasOne("STBEverywhere_Back_SharedModels.Models.RechargeCarte", null)
                        .WithMany("Frais")
                        .HasForeignKey("RechargeCarteId");
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.FraisChequier", b =>
                {
                    b.HasOne("STBEverywhere_Back_SharedModels.Models.Chequier", null)
            ...
            modelBuilder.Entity("STBEverywhere_Back_SharedModels.Models.NotificationReclamation", b =>
                {
                    b.HasOne("STBEverywhere_Back_SharedModels.Client", "Client")
                        .WithMany("NotificationsReclamation")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
